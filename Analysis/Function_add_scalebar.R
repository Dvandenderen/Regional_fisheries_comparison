...
# https://stackoverflow.com/questions/17151024/adding-scale-bar-to-ggplot-map
...
scaleBar <- function(lon, lat, distanceLon, distanceLat, distanceLegend,
                     dist.unit = "km", rec.fill = "white", rec.colour = "white", rec2.fill
                     = "black", rec2.colour = "black", legend.colour = "white", legend.size = 3, orientation = TRUE, arrow.length = 500, arrow.distance = 300, arrow.North.size = 6){
